...
```bash
npx github:fabysdev/agents#v0.29.0 --tool copilot
npx github:fabysdev/agents#v0.29.0 --tool opencode
npx github:fabysdev/agents#v0.29.0 --tool claude
npx github:fabysdev/agents#v0.29.0 --tool copilot --force
```
